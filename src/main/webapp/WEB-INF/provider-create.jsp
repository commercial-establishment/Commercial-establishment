...
<head>
  ...
  <title>Редактирование данных поставщика</title>
...
<div id="wrapper">
  ...
  <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="index.html">SB Provider</a>
    </div>
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            ...
            <li>
              <i class="fa fa-table"></i> <a href="<c:url value="/providers"/>">Список администраторов</a>
            </li>
            <li class="active">
      ...
      <div class="col-lg-12">
        <div class="table-responsive">
          <form:form method="post" action="/providers/create-save" modelAttribute="provider">
