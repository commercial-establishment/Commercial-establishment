      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">
              <i class="fa fa-desktop"></i> Редантирование данных
            </li>
          </ol>
        </div>
      </div>
      <div class="col-lg-12">
        <div class="table-responsive">
          <table class="table table-hover">
            ...
            <tr>
              <td><button type="button" class="btn btn-lg btn-default">Редактировать</button></td>
              <td><button type="button" class="btn btn-lg btn-danger">Удалить</button></td>
            </tr>
            </tbody>
          </table>
        </div>
