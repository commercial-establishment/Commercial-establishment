...
<head>
  ...
  <title>Редактирование данных о поставщике</title>
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">
              <i class="fa fa-desktop"></i> <a href="<c:url value="/providers/${provider.id}"/>">Информация о
              поставщике</a>
            </li>
            <li class="active">
              <i class="fa fa-edit"></i> Редаkтирование данных
            </li>
          </ol>
        </div>
      </div>
      <div class="col-lg-12">
        <div class="table-responsive">
          <form:form method="post" action="/providers/${id}/edit" modelAttribute="provider" commandName="provider">
